...
export function TableGrid({ onTableSelect }: TableGridProps) {
  ...
  return (
    <div className="flex flex-col h-full">
            ...
            <div className="grid grid-cols-4 sm:grid-cols-6 lg:grid-cols-8 gap-3">
              {section.tables.map((table) => (
                ...
                >
                  ...
                  {table.currentAmount && (
                    <span className="absolute -top-2 -right-2 bg-accent text-accent-foreground text-[10px] font-mono font-bold px-1.5 py-0.5 rounded-full">
                      ₹{table.currentAmount}
                    </span>
                  )}
                </button>
      ...
      <div className="border-t border-border pt-3 mt-2 flex items-center gap-2 flex-wrap bg-background">
