...
BEGIN
  ...
  DELETE FROM payment_details WHERE true;
  GET DIAGNOSTICS deleted_payments = ROW_COUNT;

  DELETE FROM bill_items WHERE true;
  ...
  UPDATE tables SET status = 'available', current_bill_id = NULL, current_amount = NULL WHERE true;
